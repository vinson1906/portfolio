      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Professional <span className="text-[#6BF216] dark:text-[#6BF216]">Experience</span>
          </h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div ref={cardRef} className="relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300">
            {/* Timeline dot */}
            <div className="absolute -left-4 top-8 w-8 h-8 bg-[#6BF216] rounded-full border-4 border-white dark:border-gray-800"></div>

            <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-6">
              <div>
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                  <Briefcase className="w-6 h-6 text-[#6BF216]" />
              ...
              <ul className="space-y-3">
                {achievements.map((achievement, index) => (
                  <li key={index} className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-[#6BF216] rounded-full mt-2 flex-shrink-0"></div>
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {['React.js', 'Node.js', 'Express.js', 'MongoDB', 'AWS S3', 'REST APIs', 'Tailwind CSS', 'Docker', 'Azure'].map((tech) => (
                  <span key={tech} className="px-3 py-1 bg-[#070707] dark:bg-[#7cd73a] text-white dark:text-black font-semibold text-sm rounded-full">
                    {tech}
                  </span>
                ))}
              </div>
